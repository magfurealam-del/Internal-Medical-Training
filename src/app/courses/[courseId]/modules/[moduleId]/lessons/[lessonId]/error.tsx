...
export default function LessonError({ reset }: { error: Error; reset: () => void }) {
  return (
    <main className="mx-auto max-w-4xl px-6 py-24 lg:px-10 text-center">
      ...
      <h1 className="mt-3 text-3xl font-semibold text-[#002f65]">Could not load lesson</h1>
      <p className="mt-3 text-[#526b78]">Something went wrong loading this lesson. Please try again.</p>
      <button
        onClick={reset}
