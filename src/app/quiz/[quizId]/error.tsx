...
export default function QuizError({ reset }: { error: Error; reset: () => void }) {
  return (
    <main className="mx-auto max-w-4xl px-6 py-24 lg:px-10 text-center">
      <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#9d2c25]">Error</p>
      <h1 className="mt-3 text-3xl font-semibold text-[#002f65]">Could not load assessment</h1>
      <p className="mt-3 text-[#526b78]">Something went wrong loading this assessment. Please try again.</p>
      <button
        onClick={reset}
